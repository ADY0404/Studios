...
class Service(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, default=0.00, help_text="Price in Ghana Cedis (GH₵) (0 for free)")
    ...
    def __str__(self):
        return f"{self.title} ({self.duration_minutes}m) - GH₵{self.price}"
